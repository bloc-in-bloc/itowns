<a name="2.46.1-next.77"></a>
## [2.46.1-next.77](https://github.com/bloc-in-bloc/itowns/compare/v2.46.0...v2.46.1-next.77) (2026-09-04)


### Features

* add Docker support ([9c61e23](https://github.com/bloc-in-bloc/itowns/commit/9c61e23))
* Add support for Cloud Optimized Geotiff ([4933b31](https://github.com/bloc-in-bloc/itowns/commit/4933b31))
* Add support for Geotiff ([a0b18a8](https://github.com/bloc-in-bloc/itowns/commit/a0b18a8))
* allow assigning a funcion to a style property after its declaration ([01be54d](https://github.com/bloc-in-bloc/itowns/commit/01be54d))
* bump itowns dependencies to latest versions ([395669d](https://github.com/bloc-in-bloc/itowns/commit/395669d))
* bump proj4 from 2.19.10 to 2.20.4 ([ec9487f](https://github.com/bloc-in-bloc/itowns/commit/ec9487f))
* **camera:** calculate dynamic, optimized camera near/far and fog ([56b722b](https://github.com/bloc-in-bloc/itowns/commit/56b722b))
* **crs:** add EPSG fetch and register helper ([170ddea](https://github.com/bloc-in-bloc/itowns/commit/170ddea))
* **demo:** added an end-user oriented demonstration of itowns capabilities ([#2653](https://github.com/bloc-in-bloc/itowns/issues/2653)) ([f452ad3](https://github.com/bloc-in-bloc/itowns/commit/f452ad3))
* **demo:** Redesign the demo, integrate into examples page ([#2773](https://github.com/bloc-in-bloc/itowns/issues/2773)) ([86df5ce](https://github.com/bloc-in-bloc/itowns/commit/86df5ce))
* deprecate file option in Potree(2)Source ([cd7a5b8](https://github.com/bloc-in-bloc/itowns/commit/cd7a5b8))
* **deps:** bump proj4 from 2.9.3 to 2.9.10 ([16cf342](https://github.com/bloc-in-bloc/itowns/commit/16cf342))
* **examples:** Revamp examples page style ([#2754](https://github.com/bloc-in-bloc/itowns/issues/2754)) ([0d37653](https://github.com/bloc-in-bloc/itowns/commit/0d37653))
* **geographic:** let user import single modules ([f160270](https://github.com/bloc-in-bloc/itowns/commit/f160270))
* implement line extrusion as cylinders ([c68762d](https://github.com/bloc-in-bloc/itowns/commit/c68762d))
* implement option to make extruded polygon roofs flat ([177d892](https://github.com/bloc-in-bloc/itowns/commit/177d892))
* **OBB:** add a cache for OrientationUtils quaternion computation ([b02b8fc](https://github.com/bloc-in-bloc/itowns/commit/b02b8fc))
* **pointcloud:** Add adaptive size mode ([#2666](https://github.com/bloc-in-bloc/itowns/issues/2666)) ([8b62da7](https://github.com/bloc-in-bloc/itowns/commit/8b62da7))
* **pointcloud:** Add events and finest visibility tracking ([#2721](https://github.com/bloc-in-bloc/itowns/issues/2721)) ([81d011c](https://github.com/bloc-in-bloc/itowns/commit/81d011c))
* **pointcloud:** add load, error and dispose events ([4dedf1d](https://github.com/bloc-in-bloc/itowns/commit/4dedf1d))
* **PointCloud:** lazy hierarchy and unified node model ([4da7bd2](https://github.com/bloc-in-bloc/itowns/commit/4da7bd2))
* **PointCloudNode:** generate bbox in a referentiel local (view Crs tranformed to z normal) ([77163e3](https://github.com/bloc-in-bloc/itowns/commit/77163e3))
* **pointcloud:** remove non-standard cin format ([a7e70a0](https://github.com/bloc-in-bloc/itowns/commit/a7e70a0))
* **pointcloud:** remove support of progressive display ([1a2ab12](https://github.com/bloc-in-bloc/itowns/commit/1a2ab12))
* **rendering:** implement physically acurate sky, atmosphere and lighting ([66a44d4](https://github.com/bloc-in-bloc/itowns/commit/66a44d4))
* revamp examples page ([#2583](https://github.com/bloc-in-bloc/itowns/issues/2583)) ([39a1121](https://github.com/bloc-in-bloc/itowns/commit/39a1121))
* **SkyController:** new simple sky mode, improvements and bug fixes ([#2790](https://github.com/bloc-in-bloc/itowns/issues/2790)) ([3db389a](https://github.com/bloc-in-bloc/itowns/commit/3db389a))
* **style:** implement runtime style changes for feature meshes ([74811a1](https://github.com/bloc-in-bloc/itowns/commit/74811a1))
* **TMSSource:** remove extra $ in url ([#2787](https://github.com/bloc-in-bloc/itowns/issues/2787)) ([e541def](https://github.com/bloc-in-bloc/itowns/commit/e541def))
* **View:** Add shadows support ([43b1587](https://github.com/bloc-in-bloc/itowns/commit/43b1587))
* **Vpc:** add VpcSource/Layer as COPC or EPT MultiSource/Layer ([ebbdfa0](https://github.com/bloc-in-bloc/itowns/commit/ebbdfa0))


### Bug Fixes

* **3dtiles:** set cache top limit to 1GB ([60a3e3c](https://github.com/bloc-in-bloc/itowns/commit/60a3e3c))
* **camera:** don't add default fog in views where camera has static near/far ([a969ced](https://github.com/bloc-in-bloc/itowns/commit/a969ced))
* **ci:** fix missing env variable for release ([e548cf0](https://github.com/bloc-in-bloc/itowns/commit/e548cf0))
* **Cog-Geotiff:** Fix tile raster dimensions ([3fedcae](https://github.com/bloc-in-bloc/itowns/commit/3fedcae))
* **cog:** Fix blank texture size ([e3f0b8b](https://github.com/bloc-in-bloc/itowns/commit/e3f0b8b))
* **cog:** Fix fallback texture format ([4452673](https://github.com/bloc-in-bloc/itowns/commit/4452673))
* **Crs:** add 'ft' as possible unit ([01dedb6](https://github.com/bloc-in-bloc/itowns/commit/01dedb6))
* **crs:** CRS.defs as an alias for proj4.defs ([41eaf39](https://github.com/bloc-in-bloc/itowns/commit/41eaf39))
* **demo:** demo not served in production environment ([#2759](https://github.com/bloc-in-bloc/itowns/issues/2759)) ([8b89a8c](https://github.com/bloc-in-bloc/itowns/commit/8b89a8c))
* **demo:** relative paths changing under certain serving conditions ([#2760](https://github.com/bloc-in-bloc/itowns/issues/2760)) ([332fb01](https://github.com/bloc-in-bloc/itowns/commit/332fb01))
* disable atmospheric lighting by default ([3bb2080](https://github.com/bloc-in-bloc/itowns/commit/3bb2080))
* **doc:** remove typescript doc for COG/Geotiff ([8bc6ed3](https://github.com/bloc-in-bloc/itowns/commit/8bc6ed3))
* **docs:** exclude sub-folder node_modules to fix doc build ([315518e](https://github.com/bloc-in-bloc/itowns/commit/315518e))
* **ElevationLayer:** don't assume Layer's Source has a TMS-like structure ([502c20b](https://github.com/bloc-in-bloc/itowns/commit/502c20b))
* **entwine:** load node Octree if we don't have children yet ([9bc62e0](https://github.com/bloc-in-bloc/itowns/commit/9bc62e0))
* **example:** fix copc_simple_loader example ([adc7d7b](https://github.com/bloc-in-bloc/itowns/commit/adc7d7b))
* **example:** fix destroy gui when we change source dataset on pointcloud examples ([7867060](https://github.com/bloc-in-bloc/itowns/commit/7867060))
* **examples:** fix duplicating panel bug, sessionStorage bugs and responsive design ([#2763](https://github.com/bloc-in-bloc/itowns/issues/2763)) ([29cddd2](https://github.com/bloc-in-bloc/itowns/commit/29cddd2))
* **examples:** Fix examples ([e83d835](https://github.com/bloc-in-bloc/itowns/commit/e83d835))
* **examples:** fix examples style regression ([#2767](https://github.com/bloc-in-bloc/itowns/issues/2767)) ([e9b5f80](https://github.com/bloc-in-bloc/itowns/commit/e9b5f80))
* **examples:** fix loading screen import in some examples ([84d9059](https://github.com/bloc-in-bloc/itowns/commit/84d9059))
* **examples:** remove obsolete osm urls ([9a988ec](https://github.com/bloc-in-bloc/itowns/commit/9a988ec))
* **examples:** wrong json layer properties ([aca1a70](https://github.com/bloc-in-bloc/itowns/commit/aca1a70))
* **example:** use original opensm source ([7f3abf4](https://github.com/bloc-in-bloc/itowns/commit/7f3abf4))
* **export:** Add missing PointCloudNode export ([#2736](https://github.com/bloc-in-bloc/itowns/issues/2736)) ([198b208](https://github.com/bloc-in-bloc/itowns/commit/198b208))
* fix 3D meshes not showing due to wrong extent check ([9364cb2](https://github.com/bloc-in-bloc/itowns/commit/9364cb2))
* fix fully transparent Mapbox buildings by preserving material intrinsic opacity ([49c69fc](https://github.com/bloc-in-bloc/itowns/commit/49c69fc))
* fix message ([3dcac80](https://github.com/bloc-in-bloc/itowns/commit/3dcac80))
* fix packages ([ca87376](https://github.com/bloc-in-bloc/itowns/commit/ca87376))
* fix resize of engine composer ([18666c0](https://github.com/bloc-in-bloc/itowns/commit/18666c0))
* fix typechecking issues ([#2771](https://github.com/bloc-in-bloc/itowns/issues/2771)) ([597db88](https://github.com/bloc-in-bloc/itowns/commit/597db88))
* fix wrong diffuse color on terrain ([a98bbb9](https://github.com/bloc-in-bloc/itowns/commit/a98bbb9))
* fix wrong install path for dependencies ([c6f5964](https://github.com/bloc-in-bloc/itowns/commit/c6f5964))
* **geographic:** fix geographic types generation ([#2742](https://github.com/bloc-in-bloc/itowns/issues/2742)) ([49e9f90](https://github.com/bloc-in-bloc/itowns/commit/49e9f90))
* **geotiff:** Fix geotiff sample ([d856fe1](https://github.com/bloc-in-bloc/itowns/commit/d856fe1))
* **globe:** refactor dynamic near & far ([#2699](https://github.com/bloc-in-bloc/itowns/issues/2699)) ([f531af6](https://github.com/bloc-in-bloc/itowns/commit/f531af6))
* make launch configuration use SwiftShader for CI compatibility ([c66b942](https://github.com/bloc-in-bloc/itowns/commit/c66b942))
* **OBB:** fix ts ([0d7bca2](https://github.com/bloc-in-bloc/itowns/commit/0d7bca2))
* **OGC3DTilesLayer:** accept 'classification' with lowercase c ([#2806](https://github.com/bloc-in-bloc/itowns/issues/2806)) ([56f189d](https://github.com/bloc-in-bloc/itowns/commit/56f189d))
* **OrientationUtils:** add UTM support ([b5b6e9a](https://github.com/bloc-in-bloc/itowns/commit/b5b6e9a))
* **PartialTexture:** fix bug when first texture is empty ([c4a77f0](https://github.com/bloc-in-bloc/itowns/commit/c4a77f0))
* **picking:** fix pointcloud picking ([36eac79](https://github.com/bloc-in-bloc/itowns/commit/36eac79))
* **picking:** make object picking robust by comparing alpha instead of colors ([2987cb1](https://github.com/bloc-in-bloc/itowns/commit/2987cb1))
* **PlanarLayer:** Delete extent from globalExtentTMS const (fix [#2244](https://github.com/bloc-in-bloc/itowns/issues/2244)) ([7fc4327](https://github.com/bloc-in-bloc/itowns/commit/7fc4327))
* **PlanarView:** Add option in planarView to prevent dynamic near/far calculation ([2c83b28](https://github.com/bloc-in-bloc/itowns/commit/2c83b28))
* **pointcloud:** fix node loading mechanism ([5a30a77](https://github.com/bloc-in-bloc/itowns/commit/5a30a77))
* **pointcloud:** Fix pointcloud debugBoxes ([#2782](https://github.com/bloc-in-bloc/itowns/issues/2782)) ([bfbe1ba](https://github.com/bloc-in-bloc/itowns/commit/bfbe1ba))
* **PointCloud:** flickering and matrixInverse.copy() ([194e371](https://github.com/bloc-in-bloc/itowns/commit/194e371))
* **PointCloudLayer:** move debug functions to Debug/PointCloudDebug ([43eaeaf](https://github.com/bloc-in-bloc/itowns/commit/43eaeaf))
* **PointCloudNode:** fix id unicity for copc and ept nodes ([76cf6bd](https://github.com/bloc-in-bloc/itowns/commit/76cf6bd))
* **PointCloudNode:** fix mode in material ([d8ee5fb](https://github.com/bloc-in-bloc/itowns/commit/d8ee5fb))
* **PointCloudNode:** project child node.obb after computation ([c3d645c](https://github.com/bloc-in-bloc/itowns/commit/c3d645c))
* **PointCloudNode:** use copy instead of clone ([2fd1810](https://github.com/bloc-in-bloc/itowns/commit/2fd1810))
* **pointcloud:** prevent query on missing Potree2 hierarchy ([8667d35](https://github.com/bloc-in-bloc/itowns/commit/8667d35))
* **PointCloud:** projection in a custom local referentiel ([976b4e4](https://github.com/bloc-in-bloc/itowns/commit/976b4e4))
* **PointVS:** fix for pointCloud elevation display ([4d52ac8](https://github.com/bloc-in-bloc/itowns/commit/4d52ac8))
* **Potree2:** add reprojection in Potree2BrotliLoader ([cdd2013](https://github.com/bloc-in-bloc/itowns/commit/cdd2013))
* **Potree2BinParser:** fix error in pointAttributes property ([9b24c35](https://github.com/bloc-in-bloc/itowns/commit/9b24c35))
* **potree2:** incorrect node info ([4e9da4d](https://github.com/bloc-in-bloc/itowns/commit/4e9da4d))
* **renderer:** restore renderer/VR state after texture rendering ([7277c52](https://github.com/bloc-in-bloc/itowns/commit/7277c52))
* **renderer:** track render target usage before cleaning them up, to fix prematurely unloading textures ([9a2c86a](https://github.com/bloc-in-bloc/itowns/commit/9a2c86a))
* **rendering:** fix aerial perspective logarithmic depth bug ([b800b98](https://github.com/bloc-in-bloc/itowns/commit/b800b98))
* **rendering:** remove tone mapping in realistic lighting & adapt shaders ([54cc94a](https://github.com/bloc-in-bloc/itowns/commit/54cc94a))
* **scheduler:** use different URI construct due to non-standard webpack handling ([1d4b404](https://github.com/bloc-in-bloc/itowns/commit/1d4b404))
* **test:** add test for CRS.defsFromWkt() ([86bbbbb](https://github.com/bloc-in-bloc/itowns/commit/86bbbbb))
* **test:** vpc test time out ([6646776](https://github.com/bloc-in-bloc/itowns/commit/6646776))
* **test:** wrong tile picking ([af9b392](https://github.com/bloc-in-bloc/itowns/commit/af9b392))
* **TileBuilder:** resolve computeExtraOffset type pain ([05d9e5f](https://github.com/bloc-in-bloc/itowns/commit/05d9e5f))
* **TileLayer:** fix material opacity ([71fa255](https://github.com/bloc-in-bloc/itowns/commit/71fa255))
* trigger ci ([fd6161c](https://github.com/bloc-in-bloc/itowns/commit/fd6161c))
* **types:** Fix types output location ([#2737](https://github.com/bloc-in-bloc/itowns/issues/2737)) ([de13f85](https://github.com/bloc-in-bloc/itowns/commit/de13f85))
* update package-lock ([c042340](https://github.com/bloc-in-bloc/itowns/commit/c042340))
* update packages ([473ab2b](https://github.com/bloc-in-bloc/itowns/commit/473ab2b))
* Update packages ([68366cf](https://github.com/bloc-in-bloc/itowns/commit/68366cf))
* **VectorTileParser:** generate generic mvtStyle when not existing ([db45264](https://github.com/bloc-in-bloc/itowns/commit/db45264))
* **view:** consider user provided renderer at view disposal ([2843ca9](https://github.com/bloc-in-bloc/itowns/commit/2843ca9))
* **view:** improve view disposal ([5e91535](https://github.com/bloc-in-bloc/itowns/commit/5e91535))
* **vpc:** fixes: typos and correct bounds for OBBes ([bbdd27d](https://github.com/bloc-in-bloc/itowns/commit/bbdd27d))
* **VpcLayer:** fix 'root' nodes -> add them all to layer.object3d ([483bfa8](https://github.com/bloc-in-bloc/itowns/commit/483bfa8))
* **VpcLayer:** fix root Node OBB calculation with huge extent ([ad8512d](https://github.com/bloc-in-bloc/itowns/commit/ad8512d))
* **VPC:** reprojection for VPC layer ([e05324e](https://github.com/bloc-in-bloc/itowns/commit/e05324e))
* **Vpc:** use scheduler to fetch source.metadata ([1bdfb37](https://github.com/bloc-in-bloc/itowns/commit/1bdfb37))
* **worker:** no support three in worker ([bdf49ed](https://github.com/bloc-in-bloc/itowns/commit/bdf49ed))


### Examples

* add copc_3d_loader to example menu ([628f03e](https://github.com/bloc-in-bloc/itowns/commit/628f03e))
* add default datasets for point clouds examples ([6ff72dc](https://github.com/bloc-in-bloc/itowns/commit/6ff72dc))
* add generic pointcloud loader examples ([ad34e02](https://github.com/bloc-in-bloc/itowns/commit/ad34e02))
* **mars:** fix invalid wmts service ([8d4652e](https://github.com/bloc-in-bloc/itowns/commit/8d4652e))
* **PointCloudLayer:** add copc_3D_loader example and new dataset ([618d989](https://github.com/bloc-in-bloc/itowns/commit/618d989))
* **Potree:** add new data set v1.7 for sub hierarchy tests ([ceb188e](https://github.com/bloc-in-bloc/itowns/commit/ceb188e))
* **Potree:** remove the extra '/' in url ([c0118ec](https://github.com/bloc-in-bloc/itowns/commit/c0118ec))
* **vpc:** add 3d loader ([a14d2cd](https://github.com/bloc-in-bloc/itowns/commit/a14d2cd))
* **Vpc:** update to three 0.182 ([5409c67](https://github.com/bloc-in-bloc/itowns/commit/5409c67))


### Code Refactoring

* centralise 2D rendering context ([#2825](https://github.com/bloc-in-bloc/itowns/issues/2825)) ([23ef24a](https://github.com/bloc-in-bloc/itowns/commit/23ef24a))
* **CRS:** move proj4Cache to CRS and use it where it's needed ([876bf16](https://github.com/bloc-in-bloc/itowns/commit/876bf16))
* **Errors:** clean up catch path of errors ([4fa9b47](https://github.com/bloc-in-bloc/itowns/commit/4fa9b47))
* **geographic:** don't use three default import ([be2ec44](https://github.com/bloc-in-bloc/itowns/commit/be2ec44))
* **LASLoader:** use three in LASLoader ([c28ce52](https://github.com/bloc-in-bloc/itowns/commit/c28ce52))
* **LASParser:** reproj data during parsing ([43290af](https://github.com/bloc-in-bloc/itowns/commit/43290af))
* migrate MainLoop to TypeScript ([#2675](https://github.com/bloc-in-bloc/itowns/issues/2675)) ([844cd4f](https://github.com/bloc-in-bloc/itowns/commit/844cd4f))
* migrate OBB to typescript ([7aaf134](https://github.com/bloc-in-bloc/itowns/commit/7aaf134))
* migrate TileMesh to typescript ([31a364f](https://github.com/bloc-in-bloc/itowns/commit/31a364f))
* **OBB:** change computation of matrixWorldInverse ([9daccc4](https://github.com/bloc-in-bloc/itowns/commit/9daccc4))
* **OBB:** move node.OBBes computation to OBB.ts ([e11829a](https://github.com/bloc-in-bloc/itowns/commit/e11829a))
* **PointCloud:** add OBBes to Group at Layer and not at Node ([5d32483](https://github.com/bloc-in-bloc/itowns/commit/5d32483))
* **PointCloud:** factorize load method ([90b3f01](https://github.com/bloc-in-bloc/itowns/commit/90b3f01))
* **pointcloud:** homogenize point cloud nodes and fix potree issue ([#2687](https://github.com/bloc-in-bloc/itowns/issues/2687)) ([9070b66](https://github.com/bloc-in-bloc/itowns/commit/9070b66))
* **PointCloudLayer:** add obbes to 'obbes' group for performance ([6492a41](https://github.com/bloc-in-bloc/itowns/commit/6492a41))
* **PointCloudLayer:** fix whenReady ([bd10f61](https://github.com/bloc-in-bloc/itowns/commit/bd10f61))
* **PointCloudLayer:** supp addInitializationStep() ([60a0092](https://github.com/bloc-in-bloc/itowns/commit/60a0092))
* **PointCloudNode:** move center to OBB ([d062881](https://github.com/bloc-in-bloc/itowns/commit/d062881))
* **PointCloudNode:** move depth to Parent Class ([97165e2](https://github.com/bloc-in-bloc/itowns/commit/97165e2))
* **PointCloudNode:** remove reference to layer in Node (use source directly) ([662f273](https://github.com/bloc-in-bloc/itowns/commit/662f273))
* **PotreeNodes:** add index as property of the node ([ac15109](https://github.com/bloc-in-bloc/itowns/commit/ac15109))
* **PtCloudProvider:** supp position and rotation in userData ([5b4705f](https://github.com/bloc-in-bloc/itowns/commit/5b4705f))
* **RenderMode:** typescript and simplification ([4dca3d4](https://github.com/bloc-in-bloc/itowns/commit/4dca3d4))
* rewrite code checking extrusion height was set, defining setter/getter separately ([6a6ee3b](https://github.com/bloc-in-bloc/itowns/commit/6a6ee3b))
* **Source:** refactor extentInsideLimit() to hasData() ([3c64961](https://github.com/bloc-in-bloc/itowns/commit/3c64961))
* **VpcSource:** cleanup ([a9b8a77](https://github.com/bloc-in-bloc/itowns/commit/a9b8a77))


### Workflow and chores

* bump dev dependencies to latest version ([edc8544](https://github.com/bloc-in-bloc/itowns/commit/edc8544))
* bump vulnerable dependencies ([117b278](https://github.com/bloc-in-bloc/itowns/commit/117b278))
* **Cog-Geotiff:** rewrite relative imports ([67832d6](https://github.com/bloc-in-bloc/itowns/commit/67832d6))
* **contributors:** addition of myself as long overdue ([bbda503](https://github.com/bloc-in-bloc/itowns/commit/bbda503))
* **deps-dev:** bump [@babel](https://github.com/babel)/plugin-transform-modules-systemjs ([4f6333b](https://github.com/bloc-in-bloc/itowns/commit/4f6333b))
* **deps-dev:** bump [@xmldom](https://github.com/xmldom)/xmldom from 0.8.11 to 0.8.12 ([2a66c47](https://github.com/bloc-in-bloc/itowns/commit/2a66c47))
* **deps-dev:** bump [@xmldom](https://github.com/xmldom)/xmldom from 0.8.12 to 0.8.13 ([5a28502](https://github.com/bloc-in-bloc/itowns/commit/5a28502))
* **deps-dev:** bump basic-ftp from 5.2.0 to 5.2.2 ([08e08f5](https://github.com/bloc-in-bloc/itowns/commit/08e08f5))
* **deps-dev:** bump fast-uri from 3.1.0 to 3.1.2 ([d290144](https://github.com/bloc-in-bloc/itowns/commit/d290144))
* **deps-dev:** bump follow-redirects from 1.15.11 to 1.16.0 ([5673508](https://github.com/bloc-in-bloc/itowns/commit/5673508))
* **deps-dev:** bump handlebars from 4.7.8 to 4.7.9 ([2451347](https://github.com/bloc-in-bloc/itowns/commit/2451347))
* **deps-dev:** bump ip-address from 10.1.0 to 10.2.0 ([bcd9ce1](https://github.com/bloc-in-bloc/itowns/commit/bcd9ce1))
* **deps-dev:** bump js-yaml from 4.1.0 to 4.1.1 ([710d2d6](https://github.com/bloc-in-bloc/itowns/commit/710d2d6))
* **deps-dev:** bump js-yaml from 4.1.0 to 4.1.1 ([4e7d0cf](https://github.com/bloc-in-bloc/itowns/commit/4e7d0cf))
* **deps-dev:** bump node-forge from 1.3.1 to 1.3.3 ([5b1abcf](https://github.com/bloc-in-bloc/itowns/commit/5b1abcf))
* **deps-dev:** bump webpack-dev-server from 5.2.3 to 5.2.4 ([8776c04](https://github.com/bloc-in-bloc/itowns/commit/8776c04))
* **deps:** bump lodash from 4.17.21 to 4.17.23 ([c1c128c](https://github.com/bloc-in-bloc/itowns/commit/c1c128c))
* **deps:** bump lodash from 4.17.23 to 4.18.1 ([11fdbe0](https://github.com/bloc-in-bloc/itowns/commit/11fdbe0))
* **deps:** bump picomatch ([#2728](https://github.com/bloc-in-bloc/itowns/issues/2728)) ([683b293](https://github.com/bloc-in-bloc/itowns/commit/683b293))
* **deps:** bump protocol-buffers-schema from 3.6.0 to 3.6.1 ([9c45d72](https://github.com/bloc-in-bloc/itowns/commit/9c45d72))
* **deps:** bump qs and express ([e2a5988](https://github.com/bloc-in-bloc/itowns/commit/e2a5988))
* fix incorrect version bumping script ([#2775](https://github.com/bloc-in-bloc/itowns/issues/2775)) ([960c766](https://github.com/bloc-in-bloc/itowns/commit/960c766))
* **geographic:** mark module-levels function as pure ([872baed](https://github.com/bloc-in-bloc/itowns/commit/872baed))
* **integration:** rearrangement of jobs and rework on regex (check commit messages) ([11e70f6](https://github.com/bloc-in-bloc/itowns/commit/11e70f6))
* **integration:** update job names to match Node version ([00e8ead](https://github.com/bloc-in-bloc/itowns/commit/00e8ead))
* migrate convertToTile to typescript ([c6e9175](https://github.com/bloc-in-bloc/itowns/commit/c6e9175))
* migrate eslint to v9 ([#2781](https://github.com/bloc-in-bloc/itowns/issues/2781)) ([9f946ad](https://github.com/bloc-in-bloc/itowns/commit/9f946ad))
* migrate scripts to ESM ([#2779](https://github.com/bloc-in-bloc/itowns/issues/2779)) ([0a9b4aa](https://github.com/bloc-in-bloc/itowns/commit/0a9b4aa))
* **node:** update to node 24 ([d01b83f](https://github.com/bloc-in-bloc/itowns/commit/d01b83f))
* **pointcloud:** add priority-based update loop ([#2654](https://github.com/bloc-in-bloc/itowns/issues/2654)) ([97bdf2a](https://github.com/bloc-in-bloc/itowns/commit/97bdf2a))
* **pointcloud:** centralize disposal and unit tests ([#2762](https://github.com/bloc-in-bloc/itowns/issues/2762)) ([42d7709](https://github.com/bloc-in-bloc/itowns/commit/42d7709))
* **pointcloud:** factorize entwine/copc nodes ([2f351a5](https://github.com/bloc-in-bloc/itowns/commit/2f351a5))
* **pointcloud:** factorize potree/potree2 nodes ([1568c0b](https://github.com/bloc-in-bloc/itowns/commit/1568c0b))
* **pointcloud:** migrate layers to typescript ([ef8be5e](https://github.com/bloc-in-bloc/itowns/commit/ef8be5e))
* **pointcloud:** migrate nodes to typescript ([0165c09](https://github.com/bloc-in-bloc/itowns/commit/0165c09))
* **pointcloud:** migrate pointcloud sources to typescript ([39e0b27](https://github.com/bloc-in-bloc/itowns/commit/39e0b27))
* remove invalid import used in test context ([cd88f82](https://github.com/bloc-in-bloc/itowns/commit/cd88f82))
* remove npm token as OIDC is now used ([dbbccf9](https://github.com/bloc-in-bloc/itowns/commit/dbbccf9))
* resolve lint issues for ESLint 9 support ([#2776](https://github.com/bloc-in-bloc/itowns/issues/2776)) ([609d565](https://github.com/bloc-in-bloc/itowns/commit/609d565))
* **TileMesh:** remove dynamically added zoom property ([30c7728](https://github.com/bloc-in-bloc/itowns/commit/30c7728))
* update caniuse-lite ([e9c0786](https://github.com/bloc-in-bloc/itowns/commit/e9c0786))
* update deps of debug ([7131b8e](https://github.com/bloc-in-bloc/itowns/commit/7131b8e))
* update to three v182 ([bbd11b5](https://github.com/bloc-in-bloc/itowns/commit/bbd11b5))
* upgrade puppeteer to 25.1.0 ([#2788](https://github.com/bloc-in-bloc/itowns/issues/2788)) ([de225a0](https://github.com/bloc-in-bloc/itowns/commit/de225a0))


### Documentation

* **ColorLayer:** rewrote ambiguous documentation ([fd85969](https://github.com/bloc-in-bloc/itowns/commit/fd85969))
* **CRS:** fix error message ([57e4b3c](https://github.com/bloc-in-bloc/itowns/commit/57e4b3c))
* **LayerUpdateState:** update and refine documentation ([33d8dc7](https://github.com/bloc-in-bloc/itowns/commit/33d8dc7))
* **OBB:** update and refine documentation ([6bc71c9](https://github.com/bloc-in-bloc/itowns/commit/6bc71c9))
* Refresh README and Contributing ([b344c80](https://github.com/bloc-in-bloc/itowns/commit/b344c80))
* **TileMesh:** update and refine documentation ([0e90f3e](https://github.com/bloc-in-bloc/itowns/commit/0e90f3e))
* Update README.md ([47a1ee5](https://github.com/bloc-in-bloc/itowns/commit/47a1ee5))


### Tests

* **EptNode:** unit tests on LoadOctree ([3331469](https://github.com/bloc-in-bloc/itowns/commit/3331469))
* **functional:** modif in hook for better message ([0be9910](https://github.com/bloc-in-bloc/itowns/commit/0be9910))
* **PointCloud:** improve unit tests (copc and ept) ([209cb76](https://github.com/bloc-in-bloc/itowns/commit/209cb76))
* **PointCloudNode:** fix: add crs parameter when instantiating a node ([99e8ee6](https://github.com/bloc-in-bloc/itowns/commit/99e8ee6))
* **PointCloudNode:** update linked to custom referentiel ([4ca0617](https://github.com/bloc-in-bloc/itowns/commit/4ca0617))
* **PointCloud:** update linked to reprojection ([3c1ccb3](https://github.com/bloc-in-bloc/itowns/commit/3c1ccb3))
* **Potree:** unit test ([3c93bbe](https://github.com/bloc-in-bloc/itowns/commit/3c93bbe))
* **vectortile:** remove private token ([1ae1d9a](https://github.com/bloc-in-bloc/itowns/commit/1ae1d9a))
* **vpc:** add unit tests ([8de95be](https://github.com/bloc-in-bloc/itowns/commit/8de95be))
* **vpc:** update ([c53156b](https://github.com/bloc-in-bloc/itowns/commit/c53156b))


### Others

* 2.46.1-next.76 ([474b303](https://github.com/bloc-in-bloc/itowns/commit/474b303))
* 2.46.1-next.75 ([465adeb](https://github.com/bloc-in-bloc/itowns/commit/465adeb))
* 2.46.1-next.69 ([c8ffb1e](https://github.com/bloc-in-bloc/itowns/commit/c8ffb1e))
...
<a name="2.46.1-next.76"></a>
## [2.46.1-next.76](https://github.com/bloc-in-bloc/itowns/compare/v2.46.0...v2.46.1-next.76) (2026-09-04)

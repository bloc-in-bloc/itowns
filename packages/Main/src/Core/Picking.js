...
export default {
    ...
    pickPointsAt(view, viewCoords, radius, layer, result = []) {
        ...
        traversePickingCircle(radius, (x, y) => {
            ...
            // 0 is reserved: nothing was drawn on this pixel
            if (id === 0) {
                return;
            }
        ...
        layer.object3d.traverse((o) => {
            if (o.isPoints && o.baseId) {
                ...
                // if the picked id falls in the id range owned by `o`, the point belongs to `o`
                for (let i = 0; i < candidates.length; i++) {
                    const index = candidates[i] - o.baseId;
                    if (index < 0 || index >= o.pickingIdCount) {
                        continue;
                    }
